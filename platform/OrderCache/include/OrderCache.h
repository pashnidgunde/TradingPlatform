...
public:
    ...
    {
        return lhs.m_orderId == rhs.m_orderId && lhs.m_securityId == rhs.m_securityId && lhs.m_side == rhs.m_side && lhs.m_user == rhs.m_user && lhs.m_company == rhs.m_company && lhs.m_qty == rhs.m_qty;
    }
