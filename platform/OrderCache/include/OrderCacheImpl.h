  ...
  using Orders = boost::multi_index_container<
      ...
      boost::multi_index::indexed_by<
          boost::multi_index::hashed_unique<
              ...
              boost::multi_index::const_mem_fun<Order, OrderIdType,
                                                &Order::orderId>>,
          boost::multi_index::hashed_non_unique<
              boost::multi_index::tag<UserIdTag>,
              boost::multi_index::const_mem_fun<Order, UserIdType,
                                                &Order::user>>,
          boost::multi_index::hashed_non_unique<
              boost::multi_index::tag<SecurityIdTag>,
              boost::multi_index::const_mem_fun<
                  Order, SecurityIdType, &Order::securityId>>,
          boost::multi_index::hashed_non_unique<
              boost::multi_index::tag<SecurityIdSideTag>,
              boost::multi_index::composite_key<
                  Order,
                  boost::multi_index::const_mem_fun<Order, SecurityIdType,
                                                    &Order::securityId>,
                  boost::multi_index::const_mem_fun<Order, SideType,
                                                    &Order::side>>>>>;
