...
namespace platform {
    struct OrderIdentifier {
        ...
        friend std::ostream &operator<<(std::ostream &os, const OrderIdentifier &identifier) {
    ...
    struct OrderBookFields {
        ...
        friend std::ostream &operator<<(std::ostream &os, const OrderBookFields &fields) {
            os << "oi: " << fields.oi << " price: " << fields.price << " qty: " << fields.qty;
            return os;
        }
