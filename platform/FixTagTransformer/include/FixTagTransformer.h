...
//namespace grammer {
//    
//    x3::rule<class statement, std::pair <uint32_t, const std::string>> const statement("statement");
//    BOOST_SPIRIT_DEFINE(
//        statement
//    );
//
...
struct FixTagTransformer {
	...
	explicit FixTagTransformer(const std::string& _message, const std::vector<std::string>& rules) :
        _statement(_message),
		_rules(rules)
	{}
