...
#include <iostream>
#include "../../OrderBook/include/OrderEventListener.h"
...
struct NewMessageHandler {
    ...
    using BookListener = OrderEventListener<std::variant<platform::Ack, platform::TopOfBook<SIDE_BUY>, platform::TopOfBook<SIDE_SELL>, platform::Trades>>;
